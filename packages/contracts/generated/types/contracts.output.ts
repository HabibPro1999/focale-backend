...
// Output side: values after the server parses them (defaults filled); response bodies built from these schemas.
// Same content as ../json-schema/contracts.output.json: one type per exported
...
export type CreateClient = {
  ...
  email?: string | null;
  phone?: string | null;
  /** unrepresentable: transform. The server computes this value in code; JSON Schema cannot describe the result. */
...
/** unrepresentable: transform. The server computes this value in code; JSON Schema cannot describe the result. */
export type EmailFontSize = unknown;

/** unrepresentable: transform. The server computes this value in code; JSON Schema cannot describe the result. */
export type EmailLineHeight = unknown;
