// ============================================================================
// Reports Module - Zod Schemas & Types (wire contract)
// Ported verbatim from legacy src/modules/reports/{reports,analytics}.schema.ts.
// z.strictObject strictness, coercions, defaults, and refinements preserved.
// ============================================================================
...
export const ExportRegistrationsQuerySchema = z.strictObject({
  ...
  format: z.enum(["csv", "json", "xlsx"]).default("csv"),
  paymentStatus: z
    .enum(["PENDING", "VERIFYING", "PARTIAL", "PAID", "SPONSORED", "WAIVED", "REFUNDED"])
    .optional(),
...
export type AccessRegistrantsResponse = z.infer<typeof AccessRegistrantsResponseSchema>;
