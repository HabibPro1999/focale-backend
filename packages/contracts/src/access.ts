...
const CreateEventAccessObject = z.strictObject({
...
export const CreateEventAccessSchema = CreateEventAccessObject.refine(
  endsAfterStarts,
  endsAfterStartsError,
);

// Body variant used by the controller: eventId is injected from the path.
export const CreateEventAccessBodySchema = CreateEventAccessObject.omit({
  eventId: true,
...
// ============================================================================
// Selection Schema (for registration) — re-used by the registrations module.
// ============================================================================
