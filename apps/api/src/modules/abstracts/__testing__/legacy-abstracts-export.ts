// Verbatim copy of the pre-3.7b abstracts.export.service.ts (in-memory
// ExcelJS workbook), fed with the abstracts instead of fetching them.
// Test-only (excluded from the build): the parity test compares the streamed
// export with it.
...
export async function legacyExportAbstractsWorkbook(
  abstracts: AdminAbstractRow[],
  eventSlug: string,
