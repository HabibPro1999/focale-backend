...
// one and this agent may not edit core, so it lives here (mirrors the pricing
// module's local copy). Relocate to core and re-point imports when core gains it.
//
