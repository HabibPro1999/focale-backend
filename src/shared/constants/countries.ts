...
let countryMap: Map<string, string> | null = null;
function getCountryMap(): Map<string, string> {
  if (!countryMap) {
    countryMap = new Map(COUNTRIES.map((c) => [c.value, c.label]));
  }
  return countryMap;
}
